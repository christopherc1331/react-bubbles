...
- [ ] Explain what a token is used for.
      A token is passed back as authorization when the correct credentials are submitted to server
- [ ] What steps can you take in your web apps to keep your data secure?
      You need to make sure that you have protected pages that can only be accessed by authorized users
- [ ] Describe how web servers work.
      Web servers are used to handle requests that are made by web browsers such as returning/editing/adding data
